...
// <a className="btn btn-primary" href={`mailto:demo%20email?subject=Interested in ${encodeURIComponent(product.title)}`}>Enquire</a>
// </div>
// </div>
...
// <p>{product.desc}</p>
// <a className="btn btn-primary" href={`mailto:demo%20email?subject=Inquiry%20about%20${encodeURIComponent(product.title)}`}>Enquire</a>
// </div>
// </div>
// </div>
// </div>
